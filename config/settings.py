...
class Settings:
    ...
    base_dir: str = field(default_factory=lambda: os.getenv("BASE_DIR", str(Path(__file__).parent.parent)))
    config_dir: str = field(default_factory=lambda: os.getenv("CONFIG_DIR", str(Path(__file__).parent)))
    data_dir: str = field(default_factory=lambda: os.getenv("DATA_DIR", str(Path(__file__).parent.parent / "data")))
    dumps_dir: str = field(default_factory=lambda: os.getenv("DUMPS_DIR", str(Path(__file__).parent.parent / "data" / "dumps")))
    symbols_dir: str = field(default_factory=lambda: os.getenv("SYMBOLS_DIR", str(Path(__file__).parent.parent / "data" / "symbols")))
    reports_dir: str = field(default_factory=lambda: os.getenv("REPORTS_DIR", str(Path(__file__).parent.parent / "data" / "reports")))
    cache_dir: str = field(default_factory=lambda: os.getenv("CACHE_DIR", str(Path(__file__).parent.parent / "data" / "cache")))
